...
datafile <- system.file("nyc_squirrels_sample.csv", package = "rUrgAra")
...
# Add a company logo to a ggplot
    
Add a company logo (by default urg'ara) to a ggplot.
