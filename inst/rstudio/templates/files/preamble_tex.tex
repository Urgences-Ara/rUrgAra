...
\definecolor{blueUrgAra}{rgb}{0.0784, 0.33333, 0.5294}
...
\subsectionfont{\color{blueUrgAra}\bfseries\Large\sectionfontcustom}
...
\newcommand{\makesubsection}[3]{% {titre}{couleurBandeau}{icone}
  \fboxsep0pt
  \hspace{-1cm}%
  \colorbox{#2}{%
    \hspace{1cm}%
    \begin{minipage}[t][1cm][t]{20cm}
      \vspace{-0.5cm}\hspace{1.1cm}%
      % Redéfinition locale : sous-section en blanc seulement ici
      {\begingroup
      ...
      {\Large
        ...
        \hfill\includegraphics[height=11mm]{#3}\hspace{0.5cm}%
...
\newcommand{\makesubsectionnoicon}[2]{% {titre}{couleurBandeau}
  \fboxsep0pt
  \hspace{-1cm}%
  \colorbox{#2}{%
    \hspace{1cm}%
    \begin{minipage}[t][1cm][t]{20cm}
      \vspace{-0.5cm}\hspace{1.1cm}%
      % On redéfinit localement la couleur des sous-sections en blanc
      {\begingroup
        \subsectionfont{\color{white}\bfseries\Large\sectionfontcustom}%
        \subsection{#1}%
      \endgroup}
...
\fancypagestyle{companypagestyle}
{
    ...
    \fancyfoot[L]
    {
        \parbox[b]{\dimexpr\linewidth-2.2cm\relax}
        {
            ...
            \vspace{-0.4mm}\href{https://www.urgences-ara.fr}{www.urgences-ara.fr}
        }
    }
    \fancyfoot[R]
    {
