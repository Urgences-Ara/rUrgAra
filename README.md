...
[![Codecov test coverage](https://codecov.io/gh/CC-URGARA/rUrgAra/branch/master/graph/badge.svg)](https://app.codecov.io/gh/CC-URGARA/rUrgAra?branch=master)
<!-- badges: end -->
...
devtools::install_github("CC-URGARA/rUrgAra")
```

## Documentation

Full documentation website on: https://CC-URGARA.github.io/rUrgAra
